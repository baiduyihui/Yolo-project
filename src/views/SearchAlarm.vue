  ...
  <dv-border-box-1>
    <div class="box1">
        ...
        <el-form :inline="true" ref="SearchRef" :model="state.tableData.param" size="default">
          <el-row>
            <el-form-item label="" size="default" prop="channel">
              <el-select v-model="state.tableData.param.channel" placeholder="请选择通道" style="width: 180px">
                <el-option label="通道一" value="1" />
                <el-option label="通道二" value="2" />
              </el-select>
            </el-form-item>
            <el-form-item label="" size="default" prop="alarm_type">
              <el-select style="width: 180px" v-model="state.tableData.param.alarm_type" placeholder="请选择告警类型"
                clearable>
            ...
            <el-form-item label="" prop="start_time">
              ...
              <el-date-picker v-model="state.tableData.param.start_time" type="datetime" placeholder="请选择开始时间"
                value-format="YYYY-MM-DD hh:mm:ss" />
            </el-form-item>
            <el-form-item label="" prop="end_time" style="width: 150px;">

              <el-date-picker v-model="state.tableData.param.end_time" type="datetime" placeholder="请选择结束时间"
                value-format="YYYY-MM-DD hh:mm:ss" />
            </el-form-item>
      ...
      <el-pagination @size-change="onHandleSizeChange" @current-change="onHandleCurrentChange" :pager-count="5"
        :page-sizes="[7, 6, 5]" v-model:current-page="state.tableData.current" v-model:page-size="state.tableData.size"
        layout="total,  prev, pager, next, jumper" :total="state.tableData.length"
